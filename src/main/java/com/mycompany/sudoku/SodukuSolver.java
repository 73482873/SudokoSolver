 ...
 * @author user
 */
public class SodukuSolver extends javax.swing.JFrame {
    ...
    private void AssignTurn(JButton btn){
        ...
        no7.setBackground(Color.black);
        no8.setBackground(Color.black);
        no9.setBackground(Color.black);
        btn.setBackground(Color.blue);
        
    }
    public void ResetGame(){
        globalFlag = true;
        JButton preDefineBtn[] = {r1c4,r1c7,r1c8,r1c9,r2c1,r2c5,r2c7,r2c9,r3c1,r3c3,r3c5,r3c8,r4c5,r4c6,r4c8,r5c2,r5c3,r5c7,r5c8
        ...
        for(int i=0 ; i<9 ; i++){
            for(int j=0 ; j<9 ; j++){
                boolean flag = true;
                for(int k=0 ; k<preDefineBtn.length ; k++){
                    if(btn[i][j]==preDefineBtn[k]) flag = false;
                }
                if(flag){
                    btn[i][j].setText("");
    ...
    private void seeSolution(){
        ...
        if(globalFlag){
            globalFlag = false;
            jButtonSolution.setText("Hide soln");
            for(int i=0 ; i<9 ; i++){
                for(int j=0 ; j<9 ; j++){
                boolean flag = true;
                for(int k=0 ; k<preDefineBtn.length ; k++){
    ...
    private void checkMove(){
        ...
        for(int i=0 ; i<9 ; i++){
            ...
            jButtonCheck.setText("Check Moves");
            ResetGame();
        }
    }
    /**
     * Creates new form SodukuSolver
     */
    public SodukuSolver() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel9.setPreferredSize(new java.awt.Dimension(145, 145));
        ...
        jPanel13.setPreferredSize(new java.awt.Dimension(145, 145));
        ...
        jPanel15.setPreferredSize(new java.awt.Dimension(145, 145));
        ...
        no1.setBackground(new java.awt.Color(0, 0, 102));
        no1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jButtonSolution.setBackground(new java.awt.Color(51, 255, 0));
        jButtonSolution.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButtonSolution.setText("Solution");
        ...
        jButtonCheck.setBackground(new java.awt.Color(255, 255, 51));
        jButtonCheck.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButtonCheck.setText("Check Moves");
        ...
        no3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        no9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jButtonSolution, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jButtonCheck, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SodukuSolver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable(){
            public void run() {
                new SodukuSolver().setVisible(true);
            }
        });
    }
